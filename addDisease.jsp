            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        ...
                        <form action="addDisease.jsp">
                            <div class="container">


                                <hr>
                                <label for="name"><b>Enter Name</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="text" placeholder="Enter name of Disease " name="name" required><br>
				...
				<input type="text" placeholder="Enter Symptom 3 " name="Symptom3" required><br>
				...
				<input type="text" placeholder="Enter constraint 2 " name="Constraint2" required><br>
				<label for="name"><b>Enter Constraint 3</b></label>
				<input type="text" placeholder="Enter constraint 3 " name="Constraint3" required><br>
